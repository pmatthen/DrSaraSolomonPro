...
// TDOAuth
#define COCOAPODS_POD_AVAILABLE_TDOAuth
#define COCOAPODS_VERSION_MAJOR_TDOAuth 1
#define COCOAPODS_VERSION_MINOR_TDOAuth 0
#define COCOAPODS_VERSION_PATCH_TDOAuth 4
